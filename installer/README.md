...
该向导把同一个 GitHub Release 中的桌面助手、Codex Skill 和 Abaqus 2021 安全插件安装到当前用户目录。它不包含 Abaqus、Codex、许可证、账号、Cookie、API Key 或论文数据库会话。
...
5. 安装本地助手、Skill 和 Abaqus 2021 插件：
...
旧应用目录、旧 Skill 和旧 Abaqus 插件都会先备份或交给已有安全安装边界处理，不覆盖用户 CAE、ODB、个人模型和凭据。
